		...
		<header>
			<div id="top">
					<a class="${logo_css_class}" href="${site_default_url}" title="<@liferay.language_format arguments="${site_name}" key="go-to-x" />">
						<#if logo_profi == 'true' >
							<img class="topLogo" alt="Profi Business Theme Logo" src="${images_folder}/profi/site_logo.png"/>
						<#else>
			...
			<div class="foter-content-row">
				...
				<div class="col-right">
					<#if footer_company_logo == 'true'>
						<#if logo_profi == 'true'>
							<img class="topLogo" alt="Profi Business Theme Logo" src="${images_folder}/profi/site_logo_footer.png"/>
						<#else>
							<img class="topLogo" alt="${logo_description}" height="${site_logo_height}" src="${site_logo}" width="${site_logo_width}" />
						</#if>
					</#if>				
					<br/>
					Powered by Liferay on Profi Business Theme
				</div>
				<div class="clear"></div>
			</div>
		</div>
