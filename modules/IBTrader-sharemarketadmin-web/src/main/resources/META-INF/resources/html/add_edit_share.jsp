			...
			<aui:row>
		     ...
		     <aui:fieldset>		
				   ...
				   <% 
				      ...
				      boolean _selectedForex = _share!=null && _share.getSecurity_type().equals(ConfigKeys.SECURITY_TYPE_FOREX) ? true: false;
				   	%>				   
					...
					<aui:option value="<%=ConfigKeys.SECURITY_TYPE_FOREX%>" selected="<%=_selectedForex %>"><%=ConfigKeys.SECURITY_TYPE_FOREX%></aui:option>
