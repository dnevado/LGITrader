...
<aui:col span="9">
	<aui:container cssClass='super-awesome-container'>
		...
		<liferay-ui:search-container-column-text name="BackTesting.From" value="${BackTesting.fromDate}"/>
		<liferay-ui:search-container-column-text name="BackTesting.To" value="${BackTesting.toDate}"/>
