...
/**
 * Provides the local service utility for MarkeShare. This utility wraps
 * {@link com.ibtrader.data.service.impl.MarkeShareLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class MarkeShareLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ibtrader.data.service.impl.MarkeShareLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.ibtrader.data.model.MarkeShare addMarkeShare(
		com.ibtrader.data.model.MarkeShare markeShare) {
		return getService().addMarkeShare(markeShare);
	}
	...
	*/
	public static com.ibtrader.data.model.MarkeShare createMarkeShare(
		long marketshareId) {
		return getService().createMarkeShare(marketshareId);
	}
	...
	*/
	public static com.ibtrader.data.model.MarkeShare deleteMarkeShare(
		com.ibtrader.data.model.MarkeShare markeShare) {
		return getService().deleteMarkeShare(markeShare);
	}
	...
	*/
	public static com.ibtrader.data.model.MarkeShare deleteMarkeShare(
		...
		return getService().deleteMarkeShare(marketshareId);
	}

	public static com.ibtrader.data.model.MarkeShare fetchMarkeShare(
		long marketshareId) {
		return getService().fetchMarkeShare(marketshareId);
	}
	...
	*/
	public static com.ibtrader.data.model.MarkeShare fetchMarkeShareByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchMarkeShareByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a marke share with the primary key could not be found
	*/
	public static com.ibtrader.data.model.MarkeShare getMarkeShare(
		long marketshareId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getMarkeShare(marketshareId);
	}
	...
	*/
	public static com.ibtrader.data.model.MarkeShare getMarkeShareByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getMarkeShareByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static com.ibtrader.data.model.MarkeShare updateMarkeShare(
		com.ibtrader.data.model.MarkeShare markeShare) {
		return getService().updateMarkeShare(markeShare);
	}
	...
	*/
	public static int getMarkeSharesCount() {
		return getService().getMarkeSharesCount();
	}
	...
	*/
	public static java.util.List<com.ibtrader.data.model.MarkeShare> getMarkeShares(
		int start, int end) {
		return getService().getMarkeShares(start, end);
	}
	...
	*/
	public static java.util.List<com.ibtrader.data.model.MarkeShare> getMarkeSharesByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService().getMarkeSharesByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<com.ibtrader.data.model.MarkeShare> getMarkeSharesByUuidAndCompanyId(
		...
		return getService()
				   .getMarkeSharesByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	...
	public static MarkeShareLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<MarkeShareLocalService, MarkeShareLocalService> _serviceTracker =
		ServiceTrackerFactory.open(MarkeShareLocalService.class);
}