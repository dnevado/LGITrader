...
public interface RealtimePersistence extends BasePersistence<Realtime> {
	...
	* @return the matching realtimes
	*/
	public java.util.List<Realtime> findByDate(Date createDate);
	...
	* @return the range of matching realtimes
	*/
	public java.util.List<Realtime> findByDate(Date createDate, int start,
		int end);
	...
	* @return the matching realtimes
	*/
	public java.util.List<Realtime> findByCompanySharegGroupDate(
