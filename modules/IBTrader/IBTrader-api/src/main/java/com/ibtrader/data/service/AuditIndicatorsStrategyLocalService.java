...
/**
 * Provides the local service interface for AuditIndicatorsStrategy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuditIndicatorsStrategyLocalServiceUtil
...
public interface AuditIndicatorsStrategyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AuditIndicatorsStrategyLocalServiceUtil} to access the audit indicators strategy local service. Add custom service methods to {@link com.ibtrader.data.service.impl.AuditIndicatorsStrategyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
