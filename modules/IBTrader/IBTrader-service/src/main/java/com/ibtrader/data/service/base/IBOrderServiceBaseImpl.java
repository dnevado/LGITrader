...
import com.ibtrader.data.service.IBOrderService;
...
/**
 * Provides the base implementation for the i b order remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ibtrader.data.service.impl.IBOrderServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class IBOrderServiceBaseImpl extends BaseServiceImpl
	implements IBOrderService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ibtrader.data.service.IBOrderServiceUtil} to access the i b order remote service.
	 */
	 ...
	 */
	public IBOrderService getIBOrderService() {
	 ...
	 */
	public void setIBOrderService(IBOrderService ibOrderService) {
	...
	public String getOSGiServiceIdentifier() {
		return IBOrderService.class.getName();
	}
	...
	@BeanReference(type = IBOrderService.class)
	protected IBOrderService ibOrderService;
