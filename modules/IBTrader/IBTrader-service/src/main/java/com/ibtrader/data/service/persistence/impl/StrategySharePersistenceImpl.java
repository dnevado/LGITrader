...
public class StrategySharePersistenceImpl extends BasePersistenceImpl<StrategyShare>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_COMMPANYSHARESTRATEGYID = new FinderPath(StrategyShareModelImpl.ENTITY_CACHE_ENABLED,
			...
			StrategyShareModelImpl.SHAREID_COLUMN_BITMASK |
			StrategyShareModelImpl.STRATEGYID_COLUMN_BITMASK |
			StrategyShareModelImpl.GROUPID_COLUMN_BITMASK |
			StrategyShareModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMMPANYSHARESTRATEGYID = new FinderPath(StrategyShareModelImpl.ENTITY_CACHE_ENABLED,
			StrategyShareModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByCommpanyShareStrategyId",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Long.class.getName()
			});
	 ...
	 */
	@Override
	public int countByCommpanyShareStrategyId(long shareId, long strategyId,
		long groupId, long companyId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_COMMPANYSHARESTRATEGYID;
	...
	private static final String _FINDER_COLUMN_COMMPANYSHARESTRATEGYID_SHAREID_2 =
		"strategyShare.shareId = ? AND ";
	private static final String _FINDER_COLUMN_COMMPANYSHARESTRATEGYID_STRATEGYID_2 =
		"strategyShare.strategyId = ? AND ";
	private static final String _FINDER_COLUMN_COMMPANYSHARESTRATEGYID_GROUPID_2 =
		"strategyShare.groupId = ? AND ";
	private static final String _FINDER_COLUMN_COMMPANYSHARESTRATEGYID_COMPANYID_2 =
		"strategyShare.companyId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ACTIVECOMMPANYGROUPSHARE =
		new FinderPath(StrategyShareModelImpl.ENTITY_CACHE_ENABLED,
			StrategyShareModelImpl.FINDER_CACHE_ENABLED,
			StrategyShareImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByActiveCommpanyGroupShare",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVECOMMPANYGROUPSHARE =
		new FinderPath(StrategyShareModelImpl.ENTITY_CACHE_ENABLED,
			StrategyShareModelImpl.FINDER_CACHE_ENABLED,
			StrategyShareImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByActiveCommpanyGroupShare",
			...
			StrategyShareModelImpl.SHAREID_COLUMN_BITMASK |
			StrategyShareModelImpl.ACTIVE_COLUMN_BITMASK |
			StrategyShareModelImpl.GROUPID_COLUMN_BITMASK |
			StrategyShareModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ACTIVECOMMPANYGROUPSHARE =
		new FinderPath(StrategyShareModelImpl.ENTITY_CACHE_ENABLED,
			StrategyShareModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByActiveCommpanyGroupShare",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(), Long.class.getName()
			});
	 ...
	 */
	@Override
	public List<StrategyShare> findByActiveCommpanyGroupShare(long shareId,
		boolean active, long groupId, long companyId) {
		return findByActiveCommpanyGroupShare(shareId, active, groupId,
	...
	@Override
	public List<StrategyShare> findByActiveCommpanyGroupShare(long shareId,
		boolean active, long groupId, long companyId, int start, int end) {
		return findByActiveCommpanyGroupShare(shareId, active, groupId,
	...
	public List<StrategyShare> findByActiveCommpanyGroupShare(long shareId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVECOMMPANYGROUPSHARE;
			finderArgs = new Object[] { shareId, active, groupId, companyId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ACTIVECOMMPANYGROUPSHARE;
			finderArgs = new Object[] {
					shareId, active, groupId, companyId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (StrategyShare strategyShare : list) {
					if ((shareId != strategyShare.getShareId()) ||
							(active != strategyShare.getActive()) ||
							(groupId != strategyShare.getGroupId()) ||
							(companyId != strategyShare.getCompanyId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_SHAREID_2);

			query.append(_FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_ACTIVE_2);

			query.append(_FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_GROUPID_2);

			query.append(_FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_COMPANYID_2);
	 ...
	 */
	@Override
	public StrategyShare findByActiveCommpanyGroupShare_First(long shareId,
		boolean active, long groupId, long companyId,
		OrderByComparator<StrategyShare> orderByComparator)
		throws NoSuchStrategyShareException {
		StrategyShare strategyShare = fetchByActiveCommpanyGroupShare_First(shareId,
				active, groupId, companyId, orderByComparator);
	 ...
	 */
	@Override
	public StrategyShare fetchByActiveCommpanyGroupShare_First(long shareId,
		boolean active, long groupId, long companyId,
		OrderByComparator<StrategyShare> orderByComparator) {
		List<StrategyShare> list = findByActiveCommpanyGroupShare(shareId,
				active, groupId, companyId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public StrategyShare findByActiveCommpanyGroupShare_Last(long shareId,
		boolean active, long groupId, long companyId,
		OrderByComparator<StrategyShare> orderByComparator)
		throws NoSuchStrategyShareException {
		StrategyShare strategyShare = fetchByActiveCommpanyGroupShare_Last(shareId,
				active, groupId, companyId, orderByComparator);
	 ...
	 */
	@Override
	public StrategyShare fetchByActiveCommpanyGroupShare_Last(long shareId,
		boolean active, long groupId, long companyId,
		OrderByComparator<StrategyShare> orderByComparator) {
		int count = countByActiveCommpanyGroupShare(shareId, active, groupId,
				companyId);
		...
		List<StrategyShare> list = findByActiveCommpanyGroupShare(shareId,
				active, groupId, companyId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public StrategyShare[] findByActiveCommpanyGroupShare_PrevAndNext(
		...
		try {
			...
			array[0] = getByActiveCommpanyGroupShare_PrevAndNext(session,
					strategyShare, shareId, active, groupId, companyId,
					orderByComparator, true);

			array[1] = strategyShare;

			array[2] = getByActiveCommpanyGroupShare_PrevAndNext(session,
					strategyShare, shareId, active, groupId, companyId,
					orderByComparator, false);
	...
	protected StrategyShare getByActiveCommpanyGroupShare_PrevAndNext(
	 ...
	 */
	@Override
	public void removeByActiveCommpanyGroupShare(long shareId, boolean active,
		long groupId, long companyId) {
		for (StrategyShare strategyShare : findByActiveCommpanyGroupShare(
				shareId, active, groupId, companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(strategyShare);
		}
	}
	 ...
	 */
	@Override
	public int countByActiveCommpanyGroupShare(long shareId, boolean active,
		long groupId, long companyId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ACTIVECOMMPANYGROUPSHARE;

		Object[] finderArgs = new Object[] { shareId, active, groupId, companyId };
	...
	private static final String _FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_SHAREID_2 =
		"strategyShare.shareId = ? AND ";
	private static final String _FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_ACTIVE_2 =
		"strategyShare.active = ? AND ";
	private static final String _FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_GROUPID_2 =
		"strategyShare.groupId = ? AND ";
	private static final String _FINDER_COLUMN_ACTIVECOMMPANYGROUPSHARE_COMPANYID_2 =
		"strategyShare.companyId = ?";
	...
	public StrategyShare updateImpl(StrategyShare strategyShare) {
		...
		if (isNew || !StrategyShareModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((strategyShareModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVECOMMPANYGROUPSHARE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						strategyShareModelImpl.getOriginalShareId(),
						strategyShareModelImpl.getOriginalActive(),
						strategyShareModelImpl.getOriginalGroupId(),
						strategyShareModelImpl.getOriginalCompanyId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_ACTIVECOMMPANYGROUPSHARE,
					args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACTIVECOMMPANYGROUPSHARE,
					args);

				args = new Object[] {
						strategyShareModelImpl.getShareId(),
						strategyShareModelImpl.getActive(),
						strategyShareModelImpl.getGroupId(),
						strategyShareModelImpl.getCompanyId()
					};
	...
	protected StrategyShare toUnwrappedModel(StrategyShare strategyShare) {
		...
		strategyShareImpl.setVisible(strategyShare.isVisible());
