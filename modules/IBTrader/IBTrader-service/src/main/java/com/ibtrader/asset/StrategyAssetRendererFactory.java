...
public class StrategyAssetRendererFactory extends BaseAssetRendererFactory {
	...
	public boolean hasPermission(PermissionChecker permissionChecker, long classPK, String actionId) throws Exception 
	{
      ...
      @Reference(target = "(bundle.symbolic.name=com.ibtrader.data.service)", unbind = "-")
     public void setResourceBundleLoader(ResourceBundleLoader resourceBundleLoader) {
    }

    @Reference(target = "(osgi.web.symbolicname=com.ibtrader.data.service)",unbind = "-")
