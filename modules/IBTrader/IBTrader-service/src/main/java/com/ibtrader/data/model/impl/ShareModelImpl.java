...
public class ShareModelImpl extends BaseModelImpl<Share> implements ShareModel {
	...
	public Object clone() {
		...
		shareImpl.setPercentual_trailling_stop_lost(getPercentual_trailling_stop_lost());
	...
	public CacheModel<Share> toCacheModel() {
		...
		shareCacheModel.percentual_trailling_stop_lost = getPercentual_trailling_stop_lost();
		...
		Date simulation_end_date = getSimulation_end_date();

		if (simulation_end_date != null) {
			shareCacheModel.simulation_end_date = simulation_end_date.getTime();
		}
		else {
			shareCacheModel.simulation_end_date = Long.MIN_VALUE;
		}

		shareCacheModel.trading_hours = getTrading_hours();

		String trading_hours = shareCacheModel.trading_hours;

		if ((trading_hours != null) && (trading_hours.length() == 0)) {
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>simulation_end_date</column-name><column-value><![CDATA[");
		sb.append(getSimulation_end_date());
		sb.append("]]></column-value></column>");
		sb.append(
