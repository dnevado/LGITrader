...
import com.ibtrader.data.service.MarkeShareLocalService;
...
/**
 * Provides the base implementation for the marke share local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ibtrader.data.service.impl.MarkeShareLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class MarkeShareLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MarkeShareLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ibtrader.data.service.MarkeShareLocalServiceUtil} to access the marke share local service.
	 */
	...
	public MarkeShare addMarkeShare(MarkeShare markeShare) {
		...
		return markeSharePersistence.update(markeShare);
	}
	...
	public MarkeShare createMarkeShare(long marketshareId) {
		return markeSharePersistence.create(marketshareId);
	}
	...
	public MarkeShare deleteMarkeShare(long marketshareId)
		...
		return markeSharePersistence.remove(marketshareId);
	}
	...
	public MarkeShare deleteMarkeShare(MarkeShare markeShare) {
		return markeSharePersistence.remove(markeShare);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MarkeShare.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return markeSharePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return markeSharePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return markeSharePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public MarkeShare fetchMarkeShare(long marketshareId) {
		return markeSharePersistence.fetchByPrimaryKey(marketshareId);
	}
	 ...
	 */
	@Override
	public MarkeShare fetchMarkeShareByUuidAndGroupId(String uuid, long groupId) {
		return markeSharePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public MarkeShare getMarkeShare(long marketshareId)
		throws PortalException {
		return markeSharePersistence.findByPrimaryKey(marketshareId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(markeShareLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MarkeShare.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("marketshareId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(markeShareLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MarkeShare.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return markeShareLocalService.deleteMarkeShare((MarkeShare)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return markeSharePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MarkeShare> getMarkeSharesByUuidAndCompanyId(String uuid,
		long companyId) {
		return markeSharePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<MarkeShare> getMarkeSharesByUuidAndCompanyId(String uuid,
		...
		return markeSharePersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	@Override
	public MarkeShare getMarkeShareByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return markeSharePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<MarkeShare> getMarkeShares(int start, int end) {
		return markeSharePersistence.findAll(start, end);
	}
	...
	public int getMarkeSharesCount() {
		return markeSharePersistence.countAll();
	}
	...
	/**
	 * Returns the marke share local service.
	 *
	 * @return the marke share local service
	 */
	public MarkeShareLocalService getMarkeShareLocalService() {
		return markeShareLocalService;
	}

	/**
	 * Sets the marke share local service.
	 *
	 * @param markeShareLocalService the marke share local service
	 */
	public void setMarkeShareLocalService(
		MarkeShareLocalService markeShareLocalService) {
		this.markeShareLocalService = markeShareLocalService;
	}

	/**
	 * Returns the marke share persistence.
	 *
	 * @return the marke share persistence
	 */
	public MarkeSharePersistence getMarkeSharePersistence() {
		return markeSharePersistence;
	}

	/**
	 * Sets the marke share persistence.
	 *
	 * @param markeSharePersistence the marke share persistence
	 */
	public void setMarkeSharePersistence(
		MarkeSharePersistence markeSharePersistence) {
		this.markeSharePersistence = markeSharePersistence;
	}
	 ...
	 */
	public com.ibtrader.data.service.OrderLocalService getOrderLocalService() {
	...
	public void setOrderLocalService(
		com.ibtrader.data.service.OrderLocalService orderLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.ibtrader.data.model.MarkeShare",
			markeShareLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.ibtrader.data.model.MarkeShare");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MarkeShareLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = markeSharePersistence.getDataSource();
	...
	@BeanReference(type = MarkeShareLocalService.class)
	protected MarkeShareLocalService markeShareLocalService;
	@BeanReference(type = MarkeSharePersistence.class)
	protected MarkeSharePersistence markeSharePersistence;
	...
	@BeanReference(type = com.ibtrader.data.service.OrderLocalService.class)
	protected com.ibtrader.data.service.OrderLocalService orderLocalService;
