...
public class TIMApiWrapper implements EWrapper {
	...
	/* lOrders
	 * LISTA DE ORDENES QUE ACOMPA�AN A LA ORDEN PADRE, SOLO SE APLICA A ORDENES DE TIPO TRAIL PARA AJUSTAR BENEFICIO 
	 */
	...
	public void error(int reqId, int errorCode, String str) {
		...
		case 587:
			 ...
			 * CLIENT_ID SER� EL CLIENT_ID MAS EL RESTO DEL CONFIGURATIONID DE LA CLAVE PRIMERARIO, AL SER 
