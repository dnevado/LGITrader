...
create index IX_A03D9C10 on ibtrader_Order (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_C99DE692 on ibtrader_Order (uuid_[$COLUMN_LENGTH:75$], groupId);
